    ...
    return (
      <div>
        <div className="column is-offset-1">
          <h4 className="title is-3">鼠蟲防治記錄表</h4>
          <div className="subtitle is-5">
            日期：{}<br />
            名稱：{}<br />
            防治名稱：{}<br />
            位置說明：{}<br />
            本月累計：{this.state.thisMonth} {this.state.co ? ' 本月累計成長率：' : null}<br />
        ...
        {this.state.vn6 &&
          <div className="field is-horizontal">
            <div className="field-label">其它</div>
            <div className="field-body">
              <div className="field is-expanded">
                <input className="input" type="number"
        ...
        {this.state.vc3 &&
          <div className="field is-horizontal">
            <div className="field-label">
              <label className="label">更換捕蚊燈管</label>
            </div>
            <div className="field-body">
              <div className="field is-narrow">
                <div className="control">
        ...
        {this.state.vc5 &&
          <div className="field is-horizontal">
            <div className="field-label">
              <label className="label">更換粘鼠板</label>
            </div>
            <div className="field-body">
              <div className="field is-narrow">
                <div className="control">
        ...
        {this.state.vc6 &&
          <div className="field is-horizontal">
            <div className="field-label">
              <label className="label">更換粘鼠板+防蟻措施</label>
            </div>
            <div className="field-body">
              <div className="field is-narrow">
                <div className="control">
            ...
            <div className="field">
              <div className="dropdown is-active">
                <div className="dropdown-trigger">
                  <button className="button" onClick={this.rmkShow.bind(this)}>
                    <span>選擇</span>
                  </button>
                </div>
                {this.state.rmkShow &&
                  <div className="dropdown-menu">
                    <div className="dropdown-content">
                      {this.state.rmkList.map((item, index) => (
                        <a className="checkbox dropdown-item" key={index}
                          onClick={this.rmkSelect.bind(this, item)} >
                          <input type="checkbox"
                            checked={this.state.rmkOption.indexOf(item) >= 0}
                          />
                          {item}
                        </a>
                      ))}
